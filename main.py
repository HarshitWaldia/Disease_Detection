...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("D:\Project\disease_detection\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("D:\Project\disease_detection\Testing.csv")
...
# Heading
w2 = Label(root, justify=LEFT, text="It's Your Doctor", fg="black")
